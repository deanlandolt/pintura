...
var first = require("promised-io/lib/lazy-array").first;
var when = require("promised-io/lib/promise").when;
var getCurrentSession = require("./jsgi/session").getCurrentSession;
var Restrictive = require("perstore/lib/facet").Restrictive;
var sha1 = require("commonjs-utils/lib/sha1").b64_sha1;
...
exports.DefaultSecurity = function(){
	...
	var Class = require("perstore/lib/model").classModel;
...
var Facet = require("perstore/lib/facet").Facet;
var Restrictive = require("perstore/lib/facet").Restrictive;
