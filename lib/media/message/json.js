...
var serializeJson = require("../json").StreamingSerializer(JSON.stringify);
var Broadcaster = require("tunguska/lib/jsgi/comet").Broadcaster;
var getClientConnection =  require("tunguska/lib/jsgi/comet").getClientConnection;
