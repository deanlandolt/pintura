...
var getColumnsToExport = require("../media").getColumnsToExport;
	...
	deserialize: function(inputStream){
		return when(forEachableToString(inputStream), function(body){
			if(body.charAt(0) == "{" || body.charAt(0) == "["){
				console.log("A content type of text/plain was specified, but the content appears to be JSON, and will be parsed as JSON");
