...
var config = exports.config = {
	...
	database: require("perstore/lib/stores"),
	security: require("./security").DefaultSecurity(),
	responseCache: require("perstore/lib/store/memory").Memory({path: "response"}), //require("perstore/store/filesystem").FileSystem("response", {defaultExtension: "cache",dataFolder: "cache" }),
	serverName: "Pintura",
	customRoutes: [],
...
var Connector = require("tunguska/lib/connector").Connector;
